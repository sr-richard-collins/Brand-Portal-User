  ...
  return (
    <div className={(containerClassName ?? '') + ' logo-container'}>
      <Link to="/" className="logo-dark">
        ...
        <img src={logoDark} className={textLogo?.className} height={textLogo?.height ?? 70} width="80px" alt="logo dark" />
      </Link>
      <Link to="/" className="logo-light">
        <img src={logoLight} className={textLogo?.className} height={textLogo?.height ?? 50} width="80px" alt="logo light" />
      </Link>
    </div>
  )
}
